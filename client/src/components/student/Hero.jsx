...
function Hero() {
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-30 pt-16 px-7 md:px-0 space-y-7 text-center '>
        <h1 className='md:text-5xl text-2xl relative font-bold text-gray-200 max-w-5xl mx-auto'>
